...
<#import "components/atoms/phone-input.ftl" as phoneInput>
...
<@layout.registrationLayout
  ...
  displayMessage=!messagesPerField.existsError("username", "password", "phoneNumber")
  ;
  section
>
  <#if section="header">
    ...
    <#if realm.password>
      ...
      >
        ...
        <@input.kw
          ...
          invalid=messagesPerField.existsError("username", "password", "phoneNumber")
          label=usernameLabel
          message=kcSanitize(messagesPerField.getFirstError("username", "password", "phoneNumber"))
          name="username"
          type="text"
